...
def process(args):
    ...
    if args.visualize_data == 'True':
        Prep.visualize_data()
    conv_model= model.train_model(X_train,Y_train,X_test,Y_test,args.mode,args.epochs,args.batch_size,args.model_name,args.output)
    #Save model
    conv_model.save(args.output + 'Sat_classification.h5')
